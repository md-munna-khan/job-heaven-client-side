        ...
        <section className="shadow left-0 px-4 py-5">
          <nav className="flex justify-between items-center">
            ...
            <div className="lg:flex space-x-4 text-lg font-bold  hidden">
              {user && (
                <>
                  <NavLink to="/dashboard" className="px-4 py-2 bg-black text-white rounded hover:bg-blue-600 transition duration-300">
                    Role: {role}
                  </NavLink>
                  <NavLink to="/" className="px-4 py-2 bg-black text-white rounded hover:bg-blue-600 transition duration-300">
                    Available Coin: {coins?.defaultCoins || 0}
                  </NavLink>
                  <NavLink to="/profile" className="flex items-center px-4 py-2 bg-black text-white rounded hover:bg-blue-600 transition duration-300" >
