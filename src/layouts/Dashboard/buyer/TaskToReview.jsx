...
//   const handleApprove = async (task_title,Buyer_name,worker_email) => {
//     const notificationData = {
//       message: `Your Have Earn  Coin. From ${Buyer_name}, for completing ${task_title}`,
...
//       .then(async(result)=>{
//         axios.post(`${import.meta.env.VITE_API_URL}/notifications`, notificationData)
//         .then(() => {
...
//                     <button
//                       onClick={() => {
//                         setSubmissionIdToApprove(submission._id,submission.task_title,submission.
//                           Buyer_name
